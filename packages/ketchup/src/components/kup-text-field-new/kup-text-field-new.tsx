...
import { FTextField } from '../../f-components/f-text-field-new/f-text-field-new';
import { FTextFieldProps } from '../../f-components/f-text-field-new/f-text-field-declarations-new';
import { GenericObject, KupComponent } from '../../types/GenericTypes';
import { KupTextFieldProps } from './kup-text-field-declarations-new';
import { KupDebugCategory } from '../../utils/kup-debug/kup-debug-declarations';

@Component({
    tag: 'kup-text-field-new',
    styleUrl: 'kup-text-field-new.scss',
    shadow: true,
})
export class KupTextFieldNew {
    /**
    ...
    private setEvents(): void {
        ...
        if (root) {
            const f: HTMLElement = root.querySelector(
                '.f-text-field-new-wrapper'
            );
            if (f) {
                const inputEl: HTMLInputElement | HTMLTextAreaElement =
                    f.querySelector('.text-field__input');
